...
*  multiple:
*  single:
*  <div rzupload kelas="btn bt-sm btn-success" target="profile" multiple id="monyet" text="upload foto" icon="fa fa-cloud-upload"></div>
*  endpoint :
*  profilepic,
*/

app.directive('rzupload', function (conf,$cookies,$timeout) {
  return {
    restrict: 'A',
